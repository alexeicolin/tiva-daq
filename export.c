...
#elif UART_PORT == 1
#define UART_PORT_BASE       UART1_BASE
#define UART_INTERRUPT       INT_UART1
#define UART_PERIPH          SYSCTL_PERIPH_UART1
#define UART_GPIO_PERIPH     SYSCTL_PERIPH_GPIOC
#define UART_GPIO_PORT_BASE  GPIO_PORTC_BASE
#define UART_GPIO_PINS       (GPIO_PIN_4 | GPIO_PIN_5)
#define UART_PIN_ASSIGN_RX   GPIO_PC4_U1RX
#define UART_PIN_ASSIGN_TX   GPIO_PC5_U1TX
#define UART_UDMA_CHANNEL_TX UDMA_CHANNEL_UART1TX
#define UART_UDMA_CHANNEL_RX UDMA_CHANNEL_UART1RX
#else
#error Invalid UART_PORT
#endif
